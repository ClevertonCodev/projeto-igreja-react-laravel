...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            if (auth()->user()->tipo != 'admin' && auth()->user()->tipo != 'secretario') {
    ...
    public function destroy(Request $request, $id)
    {
        try {
            ...
            return response()->json(['success' => 'Usuário deletado com sucesso.'], Response::HTTP_OK);
        } catch (\Exception $e) {
            $code = intval($e->getCode());
            return response()->json(['error' => $e->getMessage()], $code ?: Response::HTTP_INTERNAL_SERVER_ERROR);
        }
    ...
    public function storeAdminAndSecretary(UserRequest $request)
    {
        try {
            $user =  $this->userRepository->registerAdminAndSecretary($request);
    ...
    public function updateTipo(Request $request, $id)
    {
        try {
            ...
            return response()->json(['error' => 'Status é Obrigatório.'], Response::HTTP_UNPROCESSABLE_ENTITY);
        } catch (\Exception $e) {
            $code = intval($e->getCode());
            return response()->json(['error' => $e->getMessage()], $code ?: Response::HTTP_INTERNAL_SERVER_ERROR);
        }
